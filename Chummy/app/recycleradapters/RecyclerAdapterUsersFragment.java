...
public class RecyclerAdapterUsersFragment extends  RecyclerView.Adapter<RecyclerAdapterUsersFragment.viewHolder>{
    Context context;

    ArrayList<UserListModel> users = new ArrayList<>();
    UserListModel userListModel = new UserListModel();

    public RecyclerAdapterUsersFragment(Context context, ArrayList<UserListModel> users) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
      // setting items on usertab layout
        ...
        }else if(userListModel.getUserimage()==null&& userListModel.getUsername()==null){
            holder.userimage.setImageResource(R.drawable.defaultserprofile);
            holder.username.setText("Anonymous");
        }else{
            Picasso.get().load(userListModel.getUserimage()).into(holder.userimage);
